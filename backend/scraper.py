...
def scan_single_feed(db, source_name: str, feed_url: str, forced_category: str = None):
    ...
    try:
        ...
        for entry in feed.entries[:20]:
            ...
            is_vibe = "vibe" in text_lower or "coding" in text_lower or "developer" in text_lower or "ai agent" in text_lower or "cursor" in text_lower or "copilot" in text_lower
